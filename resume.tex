...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     ...
     \textbf{Frameworks and Libraries}{: Spring Boot, Spring Security, Hibernate} \\
     \textbf{Technologies}{: JSP, REST API, AWS, Microservices} \\
     \textbf{Tools}{: Git, Postman, Docker, Kubernetes, Maven, Linux}
    }}
 \end{itemize}
