    ...
    \resumeSubHeadingListStart
      \resumeProjectHeading
          ...
          \resumeItemListStart
            ...
            \resumeItem{Devised \textbf{refine prompts} that can perform a better task as a coding prompt can only be used to generate coding responses.}
     ...
     \resumeProjectHeading
          ...
          \resumeItemListStart
            \resumeItem{Introduced a Web App with a back-end on \textbf{PHP} \& \textbf{MySQL} database and front-end using \textbf{HTML, CSS, Javascript and Bootstrap}.}
